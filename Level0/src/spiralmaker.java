...
public class spiralmaker {
	...
	public static void main(String[] args) {
		...
		String Noun=JOptionPane.showInputDialog("Noun");
		String ajective=JOptionPane.showInputDialog("Ajective");
		JOptionPane.showMessageDialog(null,"One day Bill " +  verb + "into a giant tree and hurt himself bad. His " + Noun + "got hurt really bad. Then to go on top of that Bill got hit by a " + ajective + " Duck");
